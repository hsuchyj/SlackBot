...
const AADRequestAPI_1 = require("./AADRequestAPI");
const querystring = require("querystring");
const config = require("config");
const jwt = require("jsonwebtoken");
class AADAPI {
    constructor() {
        this.requestAPI = new AADRequestAPI_1.AADRequestAPI();
    }
    getLoginURL(validationNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            let aadRequestAPI = new AADRequestAPI_1.AADRequestAPI();
            let aadAuthorizationInfo = yield aadRequestAPI.getAsync("https://login.microsoftonline.com/common/v2.0/.well-known/openid-configuration", {}, {});
     ...
     */
    getValidatedAADInformation(code) {
        return __awaiter(this, void 0, void 0, function* () {
            let aadRequestAPI = new AADRequestAPI_1.AADRequestAPI();
            let aadAuthorizationInfo = yield aadRequestAPI.getAsync("https://login.microsoftonline.com/common/v2.0/.well-known/openid-configuration", {}, {});
            aadAuthorizationInfo = JSON.parse(aadAuthorizationInfo);
            // console.log(JSON.stringify(aadAuthorizationInfo));
            let keysObject = yield aadRequestAPI.getAsync(aadAuthorizationInfo.jwks_uri, {}, {});
            ...
            let tokens = yield aadRequestAPI.postAsync(aadAuthorizationInfo.token_endpoint, headers, body);
    ...
    validateAADInformation(keys, issuerTemplateUrl, idToken) {
        ...
        for (let i = 0; i < signingCerts.length; i++) {
            try {
                ...
                let decodedToken = jwt.verify(idToken, currSigningCert, {
...
exports.AADAPI = AADAPI;

//# sourceMappingURL=AADAPI.js.map
