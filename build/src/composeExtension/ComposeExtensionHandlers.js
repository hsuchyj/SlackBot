...
class ComposeExtensionHandlers {
    ...
    static getOnQueryHandler(bot) {
        return function (event, query, callback) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let resetKeyword = session.gettext(locale_1.Strings.compose_extension_reset_keyword);
                if (queryParameter.toLowerCase() === resetKeyword.toLowerCase()) {
                    ...
                    let resetResponse = teams.ComposeExtensionResponse.message()
                        .text(session.gettext(locale_1.Strings.compose_extension_reset_message))
                        .toResponse();
                ...
                let settingKeyword = session.gettext(locale_1.Strings.compose_extension_setting_keyword);
                let settingsKeyword = session.gettext(locale_1.Strings.compose_extension_settings_keyword);
                if (queryParameter.toLowerCase() === settingKeyword.toLowerCase() ||
                ...
                if (initialRunParameter) {
                    let directionsResponse = teams.ComposeExtensionResponse.message()
                        .text(session.gettext(locale_1.Strings.compose_extension_directions))
                        .toResponse();
                ...
                request(searchApiUrl, (error, res, body) => {
                    ...
                    let promisesOfCardsAsAttachments = new Array();
    ...
    // the settings popup
    static getOnQuerySettingsUrlHandler() {
        return function (event, query, callback) {
            return __awaiter(this, void 0, void 0, function* () {
                let configResponse = getConfigResponse();
                callback(null, configResponse, 200);
    ...
    static getOnSettingsUpdateHandler(bot) {
        return function (event, query, callback) {
            return __awaiter(this, void 0, void 0, function* () {
                let session = yield DialogUtils_1.loadSessionAsync(bot, event);
                parseSettingsAndSave(query.state, session);
...
exports.ComposeExtensionHandlers = ComposeExtensionHandlers;
...
//# sourceMappingURL=ComposeExtensionHandlers.js.map
