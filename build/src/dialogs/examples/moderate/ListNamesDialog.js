...
class ListNamesDialog extends TriggerActionDialog_1.TriggerActionDialog {
    static fetchRoster(session, args, next) {
    ...
    constructor(bot) {
        super(bot, DialogIds_1.DialogIds.ListNamesDialogId, DialogMatches_1.DialogMatches.ListNamesDialogMatch, ListNamesDialog.fetchRoster);
    }
}
exports.ListNamesDialog = ListNamesDialog;

//# sourceMappingURL=ListNamesDialog.js.map
