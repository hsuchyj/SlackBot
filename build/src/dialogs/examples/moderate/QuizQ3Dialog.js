...
class QuizQ3Dialog extends TriggerActionDialog_1.TriggerActionDialog {
    static step1(session, args, next) {
        return __awaiter(this, void 0, void 0, function* () {
            let buttons = new Array();
            buttons.push(builder.CardAction.imBack(session, "y_e_s", session.gettext(locale_1.Strings.game_button_yes) + "3"));
            buttons.push(builder.CardAction.imBack(session, "n_o", session.gettext(locale_1.Strings.game_button_no) + "3"));
            let newCard = new builder.HeroCard(session)
                .title(session.gettext(locale_1.Strings.default_title) + "3")
    ...
    constructor(bot) {
        super(bot, DialogIds_1.DialogIds.QuizQ3DialogId, DialogMatches_1.DialogMatches.QuizQ3DialogMatch, [
            QuizQ3Dialog.step1,
            QuizQ3Dialog.step2,
        ]);
    }
}
exports.QuizQ3Dialog = QuizQ3Dialog;

//# sourceMappingURL=QuizQ3Dialog.js.map
