...
import { GetStudentsDialog } from "./examples/basic/GetStudentsDialog";
import { ExtendDueDateDialog } from "./examples/basic/ExtendDueDateDialog";
import { MissingDueDateDialog } from "./examples/basic/MissingDueDateDialog";
import { FailingGradesDialog } from "./examples/basic/FailingGradesDialog";
...
export class RootDialog extends builder.IntentDialog {
    ...
    public createChildDialogs(): void {
        ...
        //console.log(bot);
        // *************************** BEGINNING OF EXAMPLES ***************************
        new GetStudentsDialog(bot);
        new ExtendDueDateDialog(bot);
        new MissingDueDateDialog(bot);
        new FailingGradesDialog(bot);
