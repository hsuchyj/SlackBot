...
export const DialogIds = {
    ...
    GetStudentsDialogId: "GetStudentsDialog",
    ExtendDueDateDialogId:"ExtendDueDateDialog",
    MissingDueDateDialogId: "MissingDueDateDialog",
    FailingGradesDialogId: "FailingGradesDialog",
